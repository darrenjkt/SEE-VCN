...
def boxes_iou3d_gpu(boxes_a, boxes_b):
    ...
    Returns:
        ans_iou: (N, M)
    """
    assert boxes_a.shape[1] == boxes_b.shape[1] == 7, f'boxes_a.shape={boxes_a.shape}, boxes_b.shape={boxes_b.shape}'
...
def boxes_decoupled_iou3d_gpu(boxes_a, boxes_b):
    """
    Args:
        boxes_a: (N, 7) [x, y, z, dx, dy, dz, heading]
        boxes_b: (M, 7) [x, y, z, dx, dy, dz, heading]
    ...
    return overlaps_3d, vol_a, vol_b
