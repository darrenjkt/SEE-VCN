...
def get_args():
    ...
    # some args
    parser.add_argument('--ext_mesh_tag', type = str, default=None, help = 'export folder will be named with this')
    parser.add_argument('--exp_name', type = str, default='default', help = 'experiment name')
    parser.add_argument('--start_ckpts', type = str, default=None, help = 'reload used ckpt path')
    parser.add_argument('--ckpts', type = str, default=None, help = 'test used ckpt path')
    parser.add_argument('--val_freq', type = int, default=1, help = 'val freq')
    parser.add_argument('--test_freq', type = int, default=2, help = 'test freq')
    parser.add_argument(
        '--resume', 
        action='store_true', 
        default=False, 
    ...
    if args.test:
        args.exp_name = Path(args.ckpts).parent.stem
        args.experiment_path = Path(args.ckpts).parent
        args.tfboard_path = Path(args.ckpts).parent.parent / 'TFBoard' / args.exp_name
        args.config = args.experiment_path / 'config.yaml'
        # if args.ckpts is None:
        #     args.ckpts = args.experiment_path / 'ckpt-best.pth'
    else:
