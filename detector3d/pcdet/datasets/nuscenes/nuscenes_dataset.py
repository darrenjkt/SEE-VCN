        ...
        if kwargs['eval_metric'] == 'kitti':
            ...
            if self.dataset_cfg.get('MIN_POINTS_OF_GT', False):
                ...
                for info in self.infos:
                    minpts_mask = (info['num_lidar_pts'] >= self.dataset_cfg.MIN_POINTS_OF_GT)                    
                    for key in ['gt_boxes', 'gt_boxes_velocity', 'gt_names', 'gt_boxes_token', 'num_lidar_pts', 'num_radar_pts']:                        
                        info[key] = info[key][minpts_mask]
