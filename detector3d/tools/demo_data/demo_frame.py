...
class DemoDataset(DatasetTemplate):
    ...
    def __getitem__(self, index):
        ...
        mask = common_utils.mask_points_by_range(input_dict['points'], self.point_cloud_range)
...
def parse_config():
    ...
    parser.add_argument('--data_path', type=str, default='/SEE-VCN/data/kitti/raw_data/2011_09_26_drive_0093_sync/velodyne_points/data',
