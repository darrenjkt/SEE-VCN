...
def parse_config():
    ...
    parser.add_argument('--data_path', type=str, default='/SEEv2/data/nuscenes/v1.0-trainval/samples/partialsc_NUS-DET_PARTIALSC_VC_VAL_SHR3_EPS3_EPSCLIP1.4_CAR_NSWEEP1',
